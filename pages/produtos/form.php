        ...
        <div class="panel">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ncm" maxlength="8" value="<?= htmlspecialchars($produto['ncm'] ?? '') ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cest" value="<?= htmlspecialchars($produto['cest'] ?? '') ?>">
        ...
        <div class="panel">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" min="0" id="percentual_lucro" name="percentual_lucro"
        ...
        <div class="panel">
            ...
            <div class="form-group">
                ...
                <label>
                    ...
                    <input type="checkbox" name="vende" value="1" <?= !empty($produto['vende']) ? 'checked' : '' ?>>
            ...
            <div class="form-group">
                ...
                <label>
                    ...
                    <input type="checkbox" name="compra" value="1" <?= !empty($produto['compra']) ? 'checked' : '' ?>>
